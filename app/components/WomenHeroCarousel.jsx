...
const slideData = [
  {
    ...
    description: 'Simplicity Never Looked Better! Back to basics',
  ...
  //   ctaLink: '/collections/women',
  //   ctaText: 'Shop Now',
  //   image: '/images/hero/hero-minimal-00.jpeg',
  // },
];

function WomenHeroCarousel() {
        ...
        {slideData.map((slide, slideIndex) => (
          ...
          >
            <div className="slide--textbox">
              <div className="primary-heading--pre">{slide.subheading}</div>
